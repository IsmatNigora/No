...
<head>
  ...
  <title>Наблюдение за работой API<!--Примеры для вставки данные--></title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Журнал<!--Ссылки--></h1>
          <p class="mb-4"><!--DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.--></p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"> Журнал по API для json<!--Примеры таблиц в формате 'json'--></h6>
            </div>
            <div class="card-body">
...
echo " <a href='json_teach_2.php?login=te_l@yandex.ru&password=te_p&gro=2bpm&sub=DB'>json_teach_2.php?login=te_l@yandex.ru&password=te_p&gro=2bpm&sub=DB -  успеваемость студентов, которую видит учитель. Передается логин и пароль учителя, а также группа и ее предмет (дает просмотр только в этом году). Эта ссылка даст не только успеваемость студентов с днями посещения, но и их ФИО, которые последние элементы в подмассивах.</a> </br>";
echo " <a href='json_teach_2_get_one.php'>json_teach_2_get_one.php -ее я оставил без параметров, иначе вы введете данные, т.к. она для вставки данныx в таблицу по логину и паролю учителя с вводом группы и ее предмета, а также var[p_id]=значение  - вместо  p_id ставим цифру-номер(, но не обязательно нужную, т.к. система может все исправить - главное, чтобы они были по порядку и число переменных равнялось числу студентов в группе по предмету), а вместо значения ставим 0,1,2,-2,-3 - здесь -2 это '' - присутсвие, а -3 - это 'н' - отсутствие на паре. Выглядит это так: json_teach_2_get_one.php?login=55577@gmail.ru&password=123&gro=2bpm&sub=DB&var[0]=0&var[1]=1&var[2]=2&var[3]=-2&var[4]=-3&var[5]=-2&var[6]=-2&var[7]=-2&var[8]=-2&var[9]=-2&var[10]=-2&var[11]=-2&var[12]=-2&var[13]=-2&var[14]=-2&var[15]=-2&var[16]=-2&var[17]=-2&var[18]=-2&var[19]=-2&var[20]=-2&var[21]=-2&var[22]=-2&var[23]=-3 . Система сама определить не только то, что можете ли, но и можете ли вы сейчас это сделать(согласно расписанию), если 'да', то вы вставите данные за сегодня за эту пару.</a> </br>";
...
*/echo '<!--<br>-->Информация об вас:</br>';
//echo $_SERVER['SERVER_NAME'];echo '<br></br>';
...
$stmt->execute($params);
*/
echo "<center><b>Журнал посещений основных json-страниц из таблицы 'n_API_log_auth'</b></center>";

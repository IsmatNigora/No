...
//$vall=substr($val,strpos($val,';')+1,strpos($val,';'));

$valll=substr($val,strpos($val,',')+1);
$vall=substr($val,0,strpos($val,','));
//echo $vall;
//if($vall!=$valll){
if($vall!='' &&$valll!=''){
...
//$sql = "INSERT INTO n_2018_2019_2bpm_math (p_id,n_25_02) VALUES (:p_id, :n_25_02)";
...
<form enctype="multipart/form-data" action="secondup.php" method="POST">

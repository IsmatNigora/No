...
$sskey = FOLDER_CERTS.'/postgresql.key';
$sslcert = FOLDER_CERTS.'postgresql.crt';
 try
{
  $pdo = new PDO("pgsql:host=$host;port=$port;dbname=$db;sslmode=verify-ca;sslrootcert=$sslrootcert;sslcert=$sslcert",
  'root',null,array(
   PDO::ATTR_ERRMODE          => PDO::ERRODE_EXCEPTION,
   PDO::ATTR_EMULATE_PREPARES => TRUE,

));

$uploaddir = '/var/www/uploads/anyutka_komleva';
...
<form enctype="multipart/form-data" action="up_new.php" method="POST">

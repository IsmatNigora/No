...
<head>
  ...
  <title>Добавление пользователей с их ролью </title>
...
<body id="page-top">
 ...
 <i class="fas fa-laugh-wink"></i>
        ...
        <div class="sidebar-brand-text mx-3">группа Xайталиева <sub>администратор</sub></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="examplescsv.php">Примеры файлов csv <p>для вставки данных</p></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Загружайте в таблицу для регистрации пользователей  <a target="_blank" href="examplescsv.php"> из примера csv-файла,рядом с которым и указаны правила его составления,</a> с названием <a href='examples/n_ad_tec_stu.txt'>n_ad_tec_stu</a> <!--DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.--></p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Регистрация</h6>
            </div>
            <div class="card-body">
<?php
session_start();
...
//echo $p[$ii][0];
//$sql = "INSERT INTO admin_teacher_student(login,password,a_t_s) VALUES(:login,:password,:a_t_s)";
$sql = "INSERT INTO n_ad_tec_stu(id,login,password,a_t_s,fio) VALUES(:id,:login,:password,:a_t_s,:fio)";
...
//foreach ($pdo->query('SELECT * FROM admin_teacher_student', PDO::FETCH_ASSOC) as $row) {
foreach ($pdo->query('SELECT * FROM n_ad_tec_stu', PDO::FETCH_ASSOC) as $row) {
